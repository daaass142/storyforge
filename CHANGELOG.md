...
- 自动测试门收敛为 42 个关键测试文件 / 148 条 release-safety 测试与 6 条核心 Chromium 冒烟；完整 2728 条回归与覆盖率保留为手动 Full Regression。
- 移除依赖浏览器音频采样率环境差异的低价值媒体 E2E；专项性能与完整验收不再阻塞每次 push。

## v3.10.0 — 2026-08-28 · Agent + Harness、可编辑记忆与项目体系重建
